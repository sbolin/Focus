...
class TodayViewDataSource<Result: NSFetchRequestResult, Delegate: TodayViewDataSourceDelegate>: NSObject, UITableViewDataSource, NSFetchedResultsControllerDelegate {
  ...
  func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
    ...
    let numberOfRows = fetchedSection.numberOfObjects + globalState.numberOfGoals
    return numberOfRows
  }
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    let previousIndex = IndexPath(row: indexPath.row - globalState.numberOfGoals, section: indexPath.section)
